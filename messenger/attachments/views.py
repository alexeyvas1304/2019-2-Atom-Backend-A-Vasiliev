...
from attachments.forms import UploadAttachmentForm
...
def upload_attachment(request):
    ...
    if form.is_valid():
        ...
        message = Message.objects.create(user_id=request.user.id, chat_id=chat_id, content="вложение")
        ...
        attachment = Attachment.objects.create(user_id=int(request.user.id), chat_id=int(chat_id), message_id=int(message.id))
